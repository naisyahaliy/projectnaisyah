...
<div class="container">
    ...
    <table class="cart-table">
        ...
        <tbody>
            <tr>
                <td>
                    <img src="https://img.id.my-best.com/product_images/7ebc4b8280a74993a2b94c1114cb233b.jpg?ixlib=rails-4.3.1&q=70&lossless=0&w=800&h=800&fit=clip&s=66c80e49c39ed975693b695b1d5260f9" alt="Product 1">
                    <span class="cart-item-title">Kahf Men Eau de Toilette Spray / Parfum Pria Semprot All Varian 100 ml</span>
                </td>
                <td class="cart-item-price">Rp.135.000</td>
                <td class="cart-item-quantity"><input type="number" value="1"></td>
                <td class="cart-item-total">Rp.135.000</td>
            </tr>
            {{-- <tr>
                <td>
    ...
    <div class="cart-summary">
        ...
        <h3>Total Semua: Rp.140.000</h3>
        <a href="/transaksi" style="background-color: rgb(177, 159, 138);" class="checkout-btn">Checkout</a>
    </div>
