...
<div class="container">
    ...
    <table class="cart-table">
        ...
        <tbody>
            <tr>
                <td>
                    <img src="https://images.tokopedia.net/img/cache/700/hDjmkQ/2024/6/19/316e3fbc-9fe2-4777-804b-a66dc79a7306.jpg" alt="Product 4">
                    <span class="cart-item-title">Zwitsal Parfum Eau De Spray Body Mist Wangi Lembut Khas Zwitsal 100Ml</span>
                </td>
                <td class="cart-item-price">Rp. 45.000</td>
                <td class="cart-item-quantity"><input type="number" value="1"></td>
                <td class="cart-item-total">Rp. 45.000</td>
            </tr>
            {{-- <tr>
                <td>
    ...
    <div class="cart-summary">
        ...
        <h3>Total Semua: Rp. 50.000</h3>
        <a href="/transaksi4" style="background-color: rgb(177, 159, 138);" class="checkout-btn">Checkout</a>
    </div>
