...
<div class="container">
    ...
    <table class="cart-table">
        ...
        <tbody>
            <tr>
                <td>
                    <img src="https://images.tokopedia.net/img/cache/700/VqbcmM/2023/10/5/0767b099-4566-4f80-b679-7c2273042d71.jpg" alt="Product 4">
                    <span class="cart-item-title">My Baby Cologne [100 mL] - Parfum Minyak Wangi Bayi - Happy Time</span>
                </td>
                <td class="cart-item-price">Rp.18.720</td>
                <td class="cart-item-quantity"><input type="number" value="1"></td>
                <td class="cart-item-total">Rp.18.720</td>
            </tr>
            {{-- <tr>
                <td>
    ...
    <div class="cart-summary">
        <h3>Total: Rp18.720</h3>
        <p>Ongkos Kirim: Rp.5.000</p>
        <h3>Total Semua: Rp23.720</h3>
        <a href="/transaksi6" style="background-color: rgb(177, 159, 138);" class="checkout-btn">Checkout</a>
    </div>
