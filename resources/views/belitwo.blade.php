...
<div class="container">
    ...
    <table class="cart-table">
        ...
        <tbody>
            <tr>
                <td>
                    <img src="https://s3.ap-southeast-1.amazonaws.com/assets.femaledaily.com/images/user-review/Vitalis-Eau-de-Royale-imgfdn-43cd849a-71b3-4d8f-84dc-9022aa165901-2538429-1.png" alt="Product 1">
                    <span class="cart-item-title">VITALIS Eau De Royale | Vitalis Eau de Parfum 50 ML</span>
                </td>
                <td class="cart-item-price">Rp.66.500</td>
                <td class="cart-item-quantity"><input type="number" value="1"></td>
                <td class="cart-item-total">Rp.66.500</td>
            </tr>
            {{-- <tr>
                <td>
    ...
    <div class="cart-summary">
        <h3>Total: Rp.66.500</h3>
        <p>Ongkos Kirim: Rp.5.000</p>
        <h3>Total Semua: Rp.71.500</h3>
        <a href="/transaksi2" style="background-color: rgb(177, 159, 138);" class="checkout-btn">Checkout</a>
    </div>
