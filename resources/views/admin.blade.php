                    ...
                    <div class="card-body">
                        <form method="post" action="/auth">
                            ...
                            <div class="form-group">
                                ...
                                <input type="toko" class="form-control" id="toko" placeholder="Enter name toko" name="toko">
                            </div>
                            <a href="/dshboard" class="btn btn" style="margin-left: 130px; background-color:rgb(177, 159, 138);">Login</a>
                        </form>
                    </div>
                </div>
            </div>
