...
<div class="container">
    ...
    <table class="cart-table">
        ...
        <tbody>
            <tr>
                <td>
                    <img src="https://www.rumahparfum.com/22187-big_default_2x/154-unisex.jpg" alt="Product 1">
                    <span class="cart-item-title">Jo Malone Cologne - english pear & freesia (100ml)</span>
                </td>
                <td class="cart-item-price">Rp.1.450.000,00</td>
                <td class="cart-item-quantity"><input type="number" value="1"></td>
                <td class="cart-item-total">Rp.1.450.000,00</td>
            </tr>
            {{-- <tr>
                <td>
    ...
    <div class="cart-summary">
        <h3>Total: Rp.1.450.000,00</h3>
        <p>Ongkos Kirim: Rp.5.000</p>
        <h3>Total Semua: Rp.1.455.000,00</h3>
        <a href="/transaksi3" style="background-color: rgb(177, 159, 138);" class="checkout-btn">Checkout</a>
    </div>
