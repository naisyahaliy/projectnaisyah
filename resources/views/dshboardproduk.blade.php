...
<body>
    ...
    <a href="/produk/create" class="btn btn-primary" style="background-color: rgb(46, 58, 58); margin-left:20px;">Tambah Data</a><br>
    <body>
        <div class="search-container" style="margin-left: 70%;">
            <input type="text" placeholder="Search...">
            <a href="/search" class="btn btn" style="margin-left:5px; background-color: darkslategray; color:white;">Go</a>
        </div>
    </body>
    <div class="container-fluid py-4">
        <h3>Perfume List</h3>
